...
class Client18_2 extends Frame implements ActionListener, Runnable {
  ...
  public Client18_2() {
   ...
   public void actionPerformed(ActionEvent evt) {
        if (evt.getSource() == ChatInput) {
            try {
                outstream.writeUTF("Client> "+ChatInput.getText());
  ...
  public static void main(String args[]) {
      if (args.length < 2){
         System.out.println("USAGE: java Client18_2 [servername] [port]");	
         System.exit(1);
      }

      servername= args[0];
      port=Integer.parseInt(args[1]);
      Client18_2 ClientStart=new Client18_2();
  }
}
